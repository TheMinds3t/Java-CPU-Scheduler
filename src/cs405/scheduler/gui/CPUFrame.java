...
public class CPUFrame extends JFrame {
	...
	/**
	 * Sets the data at the specified row in the process table and repaints the process table.
	 * @param row the row to select
	 * @param data the new data to fill the row with
	 */
	...
	/**
	 * Sets the data at the specified row and column in the process table and repaints the process table.
	 * @param row the row to select
	 * @param col the column to select
	 * @param data the new data to insert at the position
	 */
	...
	/**
	 * Initializes the process table with the specified data.
	 * @param data the data for the process table cells.
	 */
	...
	/**
	 * Converts the process log to an HTML file. Used for displaying within the process log JTextPane.
	 * @param reversed whether to list the log entries in reverse order or not
	 * @return
	 */
...
//						setSystemData(, opacity, opacity, opacity);
	...
	/**
	 * Removes the extension, if any, from the given filepath.
	 * @param s the path to the file, with or without an extension
	 * @return The path with the extension removed, if present.
	 */
